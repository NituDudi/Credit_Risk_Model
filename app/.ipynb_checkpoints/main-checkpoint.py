...
from helper import predict  # Ensure this is correctly linked to your prediction_helper.py

# Set the page configuration and title
st.set_page_config(page_title="Kisaan Finance: Credit Risk Modelling", page_icon="📊")
st.title("Kisaan Finance: Credit Risk Modelling")
